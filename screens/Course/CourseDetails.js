...
import {
    ...
    Animated,
    ScrollView,
    FlatList, Slider, Image, StatusBar,
} from "react-native";
...
const Countdown = () => {
    ...
    // <Avatar.Text label={timerDisp} size={100} style={{backgroundColor: COLORS.primary3}}/>
    return (
...
const Discussion = ({article, articleId, editNoteCallback}) => {
          ...
          renderItem={({item, index}) => {
            return (
              <View style={{width: SIZES.width}}>
                ...
                {index === 2 && <Discussion article={article} articleId={articleId} editNoteCallback={handleEditNoteIcon}/>}
              </View>
            )
          }}
        />
